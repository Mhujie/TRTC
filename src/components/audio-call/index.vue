<template>
  <div class="audio-call-section">
    <div class="audio-call-section-header">你的ID是： {{loginUserInfo && (loginUserInfo.name || loginUserInfo.userId)}}</div>
    ...
    <div :class="{ 'audio-conference': true, 'is-show': isShowAudioCall }">
      ...
      <div class="audio-conference-list">
        <div v-for="userId in meetingUserIdList" :key="`audio-${userId}`" :class="{'user-audio-container': true, 'is-me': userId === loginUserInfo.userId}">
